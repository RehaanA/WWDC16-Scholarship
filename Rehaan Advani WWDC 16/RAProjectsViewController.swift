...
class RAProjectsViewController: UIViewController, UIPageViewControllerDataSource {
    ...
    func addArrows() {
        self.arrow1.image = UIImage(named: "arrow1.png")
        ...
        self.view.addConstraint(NSLayoutConstraint(item: self.arrow1, attribute: .Width, relatedBy: .Equal, toItem: self.view, attribute: .Width, multiplier: 0.2, constant: 0.0))
        self.view.addConstraint(NSLayoutConstraint(item: self.arrow1, attribute: .Height, relatedBy: .Equal, toItem: self.view, attribute: .Height, multiplier: 0.2, constant: 0.0))
        self.view.addConstraint(NSLayoutConstraint(item: self.arrow1, attribute: .CenterX, relatedBy: .Equal, toItem: self.view, attribute: .CenterX, multiplier: 1.7, constant: 0.0))
        ...
        self.arrow2.image = UIImage(named: "arrow2.png")
        ...
        self.view.addConstraint(NSLayoutConstraint(item: self.arrow2, attribute: .Width, relatedBy: .Equal, toItem: self.view, attribute: .Width, multiplier: 0.2, constant: 0.0))
        self.view.addConstraint(NSLayoutConstraint(item: self.arrow2, attribute: .Height, relatedBy: .Equal, toItem: self.view, attribute: .Height, multiplier: 0.2, constant: 0.0))
        self.view.addConstraint(NSLayoutConstraint(item: self.arrow2, attribute: .CenterX, relatedBy: .Equal, toItem: self.view, attribute: .CenterX, multiplier: 0.3, constant: 0.0))
    ...
    func navBar() {
        ...
        info.addTarget(self, action: "infoTapped:", forControlEvents: .TouchUpInside)
